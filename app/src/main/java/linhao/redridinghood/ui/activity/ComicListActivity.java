 ...
 */
public class ComicListActivity extends BaseActivty implements ActivityView, OnRefreshListener, LoadMoreView ,ItemOnClick{
    ...
    private void initToolBar() {
        ...
        toolbar.setTitle("");
        toolbarTitle.setText(R.string.comic_list);
        setSupportActionBar(toolbar);
        toolbar.setNavigationIcon(ContextCompat.getDrawable(ComicListActivity.this, R.drawable.back));
