 ...
 */
public class HotNewFirstFragemnt extends BaseFragment implements ItemOnClick {
    ...
    private static HotNewFirstFragemnt firstFragemnt;
    ...
    public static HotNewFirstFragemnt Instance() {
        if (firstFragemnt == null) {
            firstFragemnt = new HotNewFirstFragemnt();
        }
        return firstFragemnt;
    }
    ...
    private void initView() {
        ...
        pageChangeOnListener.setYearType(ConstantUtil.First_Year_Fragment_Flag);
        ...
        bundle.putInt("currentYear", ConstantUtil.First_Year_Fragment_Flag);
        itemFragment.setArguments(bundle);
    ...
    public void onResume() {
        super.onResume();
        MobclickAgent.onPageStart("HotNewFirstFragemnt");
    }

    @Override
    public void onPause() {
        super.onPause();
        MobclickAgent.onPageEnd("HotNewFirstFragemnt");
    }
