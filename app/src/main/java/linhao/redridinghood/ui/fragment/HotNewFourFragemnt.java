 ...
 */
public class HotNewFourFragemnt extends BaseFragment implements ItemOnClick{
    ...
    private static HotNewFourFragemnt fourFragemnt;
    int currentPosition = 0;

    public static HotNewFourFragemnt Instance() {
        if (fourFragemnt == null) {
            fourFragemnt = new HotNewFourFragemnt();
        }
        return fourFragemnt;
    }
    ...
    private void initView() {
        ...
        pageChangeOnListener.setYearType(ConstantUtil.Four_Year_Fragment_Flag);
        ...
        bundle.putInt("currentYear", ConstantUtil.Four_Year_Fragment_Flag);
        itemFragment.setArguments(bundle);
        hotNewAdapter.setType(ConstantUtil.Four_Year_Fragment_Flag,currentPosition);
    ...
    public void onResume() {
        super.onResume();
        MobclickAgent.onPageStart("HotNewFourFragemnt");
    }

    @Override
    public void onPause() {
        super.onPause();
        MobclickAgent.onPageEnd("HotNewFourFragemnt");
    }
